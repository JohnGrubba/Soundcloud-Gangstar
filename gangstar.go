...
func main() {
	...
	req, err := http.NewRequest("GET", "https://soundcloud.com/swerve_cc/aitor-hertz-okay", nil)
	if err != nil {
	...
	finalURL := baseURL + "?client_id=" + url.QueryEscape(clientID) + "&track_authorization=" + url.QueryEscape(track_auth)
